...
const BOOK_MAP = {
  ...
  'neh': 'NEH', 'nehemiah': 'NEH', 'esth': 'EST', 'esther': 'EST', 'est': 'EST',
  ...
  'dan': 'DAN', 'daniel': 'DAN', 'hos': 'HOS', 'hosea': 'HOS', 'joel': 'JOL', 'joel': 'JOL',
  'amos': 'AMO', 'amos': 'AMO', 'obad': 'OBA', 'obadiah': 'OBA', 'jon': 'JON', 'jonah': 'JON',
  'mic': 'MIC', 'micah': 'MIC', 'nah': 'NAM', 'nahum': 'NAM', 'hab': 'HAB', 'habakkuk': 'HAB',
  'zeph': 'ZEP', 'zephaniah': 'ZEP', 'hag': 'HAG', 'haggai': 'HAG', 'zech': 'ZEC', 'zechariah': 'ZEC', 'zec': 'ZEC',
  'mal': 'MAL', 'malachi': 'MAL', 'matt': 'MAT', 'matthew': 'MAT', 'mat': 'MAT', 'mk': 'MRK', 'mark': 'MRK',
  'lk': 'LUK', 'luke': 'LUK', 'jn': 'JHN', 'john': 'JHN', 'acts': 'ACT', 'acts': 'ACT',
  ...
  '1 tim': '1TI', '1 timothy': '1TI', '2 tim': '2TI', '2 timothy': '2TI', 'tit': 'TIT', 'titus': 'TIT',
  'phm': 'PHM', 'philemon': 'PHM', 'heb': 'HEB', 'hebrews': 'HEB', 'jas': 'JAS', 'james': 'JAS', 'jms': 'JAS',
  '1 pet': '1PE', '1 peter': '1PE', '1 pe': '1PE', '2 pet': '2PE', '2 peter': '2PE', '2 pe': '2PE',
  '1 jn': '1JN', '1 john': '1JN', '2 jn': '2JN', '2 john': '2JN', '3 jn': '3JN', '3 john': '3JN',
  'jude': 'JUD', 'jude': 'JUD', 'rev': 'REV', 'revelation': 'REV'
};
...
const fetchMBBTAG = async (refObj) => {
  try {
    ...
    return data.chapter.verses.filter(v => {
  ...
  } catch (e) { console.error(`MBBTAG Error: ${e.message}`); return []; }
};
...
exports.handler = async (event, context) => {
  ...
  if (!refObj) return { statusCode: 400, headers, body: JSON.stringify({ error: "Invalid reference" }) };
  try {
